    ...
    public class UsuarioDataAccess
    {
        ...
        public UsuarioModel Login(LoginUsuario login)
        {
            try
            {
                ...
                //    IpsosSecureResult IpsosSecureResult = IpsosSecureLogin(login.Email.ToLower(), login.Password, login.IP, (int)login.IdiomaId);

                //#if DEBUG
                //                // Código executado apenas em Debug

                //                IpsosSecureResult IpsosSecureResult = new IpsosSecureResult
                //                {
                //                    UsuarioId = 2,
                //                    Status = 200
                //                };
                //#else
                //                     Código executado em Release
