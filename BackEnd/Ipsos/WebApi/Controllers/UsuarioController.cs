        ...
        public HttpResponseMessage Login(LoginUsuario login)
        {
            ...
            try
            {
                ...
                if (usuario != null && usuario.CodUser > 0)
                {
                    ...
                    var informacao = string.Concat("Usuario Logado com sucesso - ", login.Email.ToLower(), " ", DateTime.Now.ToString());
                    _contextLog.InsertLog(new LogUsuarioModel { Email = usuario.Email.ToLower(), CodUser = usuario.CodUser, Informacao = informacao, URL = "Login" });
                ...
                else
                {
                    ...
                    _contextLog.InsertLog(new LogUsuarioModel { Email = login.Email.ToLower(), Informacao = informacao, URL = "Login" });
