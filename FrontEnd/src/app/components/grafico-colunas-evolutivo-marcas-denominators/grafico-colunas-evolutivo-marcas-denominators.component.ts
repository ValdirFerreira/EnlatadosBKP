...
@Component({
    selector: 'grafico-colunas-evolutivo-marcas-denominators',
    templateUrl: './grafico-colunas-evolutivo-marcas-denominators.component.html',
    styleUrls: ['./grafico-colunas-evolutivo-marcas-denominators.component.scss']
})
export class GraficoColunasEvolutivoMarcasDenominatorsComponent implements OnInit {
