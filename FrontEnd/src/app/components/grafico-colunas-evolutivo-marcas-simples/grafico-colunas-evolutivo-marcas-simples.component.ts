...
@Component({
    selector: 'grafico-colunas-evolutivo-marcas-simples',
    templateUrl: './grafico-colunas-evolutivo-marcas-simples.component.html',
    styleUrls: ['./grafico-colunas-evolutivo-marcas-simples.component.scss']
})
export class GraficoColunasEvolutivoMarcasSimplesComponent implements OnInit {
