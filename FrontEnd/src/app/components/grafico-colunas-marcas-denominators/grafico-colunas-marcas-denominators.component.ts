...
@Component({
    selector: 'grafico-colunas-marcas-denominators',
    templateUrl: './grafico-colunas-marcas-denominators.component.html',
    styleUrls: ['./grafico-colunas-marcas-denominators.component.scss']
})
export class GraficoColunasMarcasDenominatorsComponent implements OnInit {
