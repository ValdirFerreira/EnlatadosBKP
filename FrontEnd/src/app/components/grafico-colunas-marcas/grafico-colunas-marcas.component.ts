...
@Component({
    selector: 'grafico-colunas-marcas',
    templateUrl: './grafico-colunas-marcas.component.html',
    styleUrls: ['./grafico-colunas-marcas.component.scss']
})
export class GraficoColunasMarcasComponent implements OnInit {
