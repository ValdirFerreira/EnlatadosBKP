...
export class SidebarPortaisComponent implements OnInit {
  ...
  // private readonly baseUrlendPointPortalNestleNinhoAdulto = environment["endPointPortalChocolate"];
  ...
  openPortalSelect(codPortal: number) {
    ...
    //     if (infoEncrypt) {
    //       debugger
    //       const url = `${this.baseUrlendPointPortalNestleNinhoAdulto}?crypt=${infoEncrypt}`;
