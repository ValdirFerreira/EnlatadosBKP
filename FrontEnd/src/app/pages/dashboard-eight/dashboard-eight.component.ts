...
import { DashBoardEightService } from 'src/app/services/dashboard-eight.service';
...
@Component({
  ...
  styleUrls: ['./dashboard-eight.component.scss']
})
export class DashboardEightComponent implements OnInit {
  ...
  constructor(public router: Router,
    ...
    public filtroService: FiltroGlobalService, private downloadArquivoService: DownloadArquivoService, private dashBoardEightService: DashBoardEightService,
  ...
  ngOnInit(): void {
    ...
    this.menuService.activeMenu = 8;
    this.menuService.menuSelecao = "8"

    this.subscription = EventEmitterService.get("emit-dashboard-eight").subscribe((x) => {
  ...
  carregarGraficoComparativoMarcasFirstLoad() {
    ...
    this.dashBoardEightService.carregarGraficoComparativoMarcas(filtroColuna1)
    ...
    this.dashBoardEightService.carregarGraficoComparativoMarcas(filtroColuna2)
    ...
    this.dashBoardEightService.carregarGraficoComparativoMarcas(filtroColuna3)
    ...
    this.dashBoardEightService.carregarGraficoComparativoMarcas(filtroColuna4)
    ...
    this.dashBoardEightService.carregarGraficoComparativoMarcas(filtroColuna5)
  ...
  carregarGraficoComparativoMarcas() {
    this.dashBoardEightService.carregarGraficoComparativoMarcas(null)
  ...
  exportToPptComparativoMarcas() {
    ...
    var nome = this.translate.instant('dashboard-eight-grafico1-titulo');
    this.conversorPowerpointService.captureScreenPPTAlternative(
      'comparativo-marcas',
      nome,
    );
  ...
  exportToPptEvolutivoMarcas() {
    var nome = this.translate.instant('dashboard-eight-grafico2-titulo');
    this.conversorPowerpointService.captureScreenPPTAlternative(
      'evolutivo-marcas',
      nome
    );
  ...
  async exportToExcelGrafico1Eight() {

    var filtroPadrao = this.carregaFiltrosExcel();
    var titulo = this.translate.instant('dashboard-eight-grafico1-titulo');
    filtroPadrao.TituloGrafico = titulo;
    await this.downloadArquivoService.
      DownloadDashboardEightComparativoMarcas(filtroPadrao)
      .subscribe((result) => {
  ...
  async exportToExcelGrafico2Eight() {
    var filtroPadrao = this.carregaFiltrosExcel();
    var titulo = this.translate.instant('dashboard-eight-grafico2-titulo');
    filtroPadrao.TituloGrafico = titulo;
    await this.downloadArquivoService.
      DownloadDashboardEightEvolutivoMarcas(filtroPadrao)
      .subscribe((result) => {
