...
import { GraficoColunasMarcasSimplesModule } from 'src/app/components/grafico-colunas-marcas-simples/grafico-colunas-marcas-simples.module';
import { GraficoColunasEvolutivoMarcasSimplesModule } from 'src/app/components/grafico-colunas-evolutivo-marcas-simples/grafico-colunas-evolutivo-marcas-simples.module';
import { GraficoColunasMarcasDenominatorsModule } from 'src/app/components/grafico-colunas-marcas-denominators/grafico-colunas-marcas-denominators.module';
import { GraficoColunasEvolutivoMarcasDenominatorsModule } from 'src/app/components/grafico-colunas-evolutivo-marcas-denominators/grafico-colunas-evolutivo-marcas-denominators.module';
...
@NgModule({
  ...
  imports: [
    ...
    TranslateModule,
    SelectImageModule,
    GraficoColunasMarcasSimplesModule,
    GraficoColunasEvolutivoMarcasSimplesModule,
    GraficoColunasMarcasDenominatorsModule,
    GraficoColunasEvolutivoMarcasDenominatorsModule
  ]
})
